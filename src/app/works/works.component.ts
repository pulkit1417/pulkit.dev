...
export class WorksComponent {
    projects = [
        ...
        },
        {
            ...
            name: "Crud-App",
            description:"Expense Tracker is a web app that helps users manage personal finances by tracking and analyzing expenses with an intuitive interface.",
            link:"https://crud-app-blond-psi.vercel.app/",
        },{
            id:4,
